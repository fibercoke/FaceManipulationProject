...
#--batch_size 16 --classes ./data/plate.names --dataset ./data/train.tfrecord --epochs 50 --learning_rate 0.001 --mode fit --size 416 --val_dataset ./data/test.tfrecord --tiny --num_classes 1
